...
\begin{table}[htdp]
\caption{Normalized error on test trials for various network manipulations.}
\begin{center}
\begin{tabular}{l|c|c}
  Condition  &  Normalized Error  &  SD \\
  \hline
  Normal            &   .035   &   .003 \\
  Hid2 Lesion   &   .087   &   .028 \\
  Weak Context &  .413   &   .042 \\
  Non-TI              &  .623   &   .021 \\
\end{tabular}
\end{center}
...
%Rev1 hypothetical--rephrase or remove: Moreover, embedding both the perceptions and actions in continuous time--as they are in the real world--should enable the model to generalize well to time-warped sequences, and even to make mistakes resembling human errors. 
